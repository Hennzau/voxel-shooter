...
fn vertex(vertex: Vertex) -> VertexOutput {
    ...
    let block_id = u32(vertex.data >> 15u & x_positive_bits(4u));
    let block_health = f32(vertex.data >> 19u & x_positive_bits(4u)) / 15.0;
    let block_normal = normals[u32(vertex.data >> 23u & x_positive_bits(4u))];
